...
export const getSubmissions = async () => {
    // const res = await fetch('https://book-my-campus-server.onrender.com/submissions');
        ...
        return (
            <div className="max-w-6xl mx-auto px-4 py-8">
                ...
                <div className="text-center py-10">
                    ...
                    <p className="text-gray-500 mb-4">You haven't submitted any college applications yet.</p>
                    <Link
                        href="/admission"
