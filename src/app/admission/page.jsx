...
const AdmissionPage = () => {
    ...
    const isLoggedIn = true; // This should be replaced with actual authentication logic later
    ...
    if (loading) return <div className="text-center p-8">loading colleges...</div>;
