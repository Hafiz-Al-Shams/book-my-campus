...
const CollegeDetailPage = async ({ params }) => {
    ...
    if (singleCollege) {
        return (
            <div>
                <h1 className="text-center bg-amber-200 text-3xl">College from MongoDB -- Detail Page</h1>
                <p className="text-xl">ID: {id}</p>
                <p className="text-xl"> {singleCollege.name}</p>
                <img src={singleCollege.imgSrc} alt="" />
            </div>
        );
    }
    else {
